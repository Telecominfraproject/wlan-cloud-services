...
//       System.out.println("================================");
    ...
    public void testEquipmentPaginationWithFilters()
    {
       ...
       PaginationResponse<Equipment> page2emptyCriteria = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, locationIds, "", sortBy, page1.getContext());
       PaginationResponse<Equipment> page3emptyCriteria = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, locationIds, "", sortBy, page2.getContext());
       PaginationResponse<Equipment> page4emptyCriteria = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, locationIds, "", sortBy, page3.getContext());
       PaginationResponse<Equipment> page5emptyCriteria = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, locationIds, "", sortBy, page4.getContext());
       PaginationResponse<Equipment> page6emptyCriteria = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, locationIds, "", sortBy, page5.getContext());
       PaginationResponse<Equipment> page7emptyCriteria = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, locationIds, "", sortBy, page6.getContext());
       ...
       PaginationResponse<Equipment> page2EmptyLocationIdsSearchBaseMac = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "A1", sortBy, page1.getContext());
       PaginationResponse<Equipment> page3EmptyLocationIdsSearchBaseMac = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "A1", sortBy, page2.getContext());
       PaginationResponse<Equipment> page4EmptyLocationIdsSearchBaseMac = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "A1", sortBy, page3.getContext());
       PaginationResponse<Equipment> page5EmptyLocationIdsSearchBaseMac = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "A1", sortBy, page4.getContext());
       PaginationResponse<Equipment> page6EmptyLocationIdsSearchBaseMac = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "A1", sortBy, page5.getContext());
       PaginationResponse<Equipment> page7EmptyLocationIdsSearchBaseMac = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "A1", sortBy, page6.getContext());
       ...
       PaginationResponse<Equipment> page2EmptyLocationIdsSearchBr = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "br", sortBy, page1.getContext());
       PaginationResponse<Equipment> page3EmptyLocationIdsSearchBr = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "br", sortBy, page2.getContext());
       PaginationResponse<Equipment> page4EmptyLocationIdsSearchBr = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "br", sortBy, page3.getContext());
       PaginationResponse<Equipment> page5EmptyLocationIdsSearchBr = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "br", sortBy, page4.getContext());
       PaginationResponse<Equipment> page6EmptyLocationIdsSearchBr = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "br", sortBy, page5.getContext());
       PaginationResponse<Equipment> page7EmptyLocationIdsSearchBr = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "br", sortBy, page6.getContext());
       ...
       PaginationResponse<Equipment> page2EmptyLocationIdsSearchB1 = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "b1", sortBy, page1.getContext());
       PaginationResponse<Equipment> page3EmptyLocationIdsSearchB1 = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "b1", sortBy, page2.getContext());
       PaginationResponse<Equipment> page4EmptyLocationIdsSearchB1 = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "b1", sortBy, page3.getContext());
       PaginationResponse<Equipment> page5EmptyLocationIdsSearchB1 = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "b1", sortBy, page4.getContext());
       PaginationResponse<Equipment> page6EmptyLocationIdsSearchB1 = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "b1", sortBy, page5.getContext());
       PaginationResponse<Equipment> page7EmptyLocationIdsSearchB1 = remoteInterface.getForCustomer(customerId_1, EquipmentType.AP, emptyLocationIds, "b1", sortBy, page6.getContext());

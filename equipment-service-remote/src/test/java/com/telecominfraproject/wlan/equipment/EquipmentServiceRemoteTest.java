...
//       System.out.println("================================");
    ...
    public void testSearchByMacAndName()
    {
       ...
       // check search on mac
       PaginationContext<Equipment> context = new PaginationContext<>(10);
       PaginationResponse<Equipment> page1 = remoteInterface.searchByMacAndName(customerId_1, "A1", sortBy, context);
       PaginationResponse<Equipment> page2 = remoteInterface.searchByMacAndName(customerId_1, "A1", sortBy, page1.getContext());
       PaginationResponse<Equipment> page3 = remoteInterface.searchByMacAndName(customerId_1, "A1", sortBy, page2.getContext());
       PaginationResponse<Equipment> page4 = remoteInterface.searchByMacAndName(customerId_1, "A1", sortBy, page3.getContext());
       PaginationResponse<Equipment> page5 = remoteInterface.searchByMacAndName(customerId_1, "A1", sortBy, page4.getContext());
       PaginationResponse<Equipment> page6 = remoteInterface.searchByMacAndName(customerId_1, "A1", sortBy, page5.getContext());
       PaginationResponse<Equipment> page7 = remoteInterface.searchByMacAndName(customerId_1, "A1", sortBy, page6.getContext());
       ...
       PaginationResponse<Equipment> page1_name = remoteInterface.searchByMacAndName(customerId_1, "qr", sortBy, context_name);
       PaginationResponse<Equipment> page2_name = remoteInterface.searchByMacAndName(customerId_1, "qr", sortBy, page1_name.getContext());
       PaginationResponse<Equipment> page3_name = remoteInterface.searchByMacAndName(customerId_1, "qr", sortBy, page2_name.getContext());
       PaginationResponse<Equipment> page4_name = remoteInterface.searchByMacAndName(customerId_1, "qr", sortBy, page3_name.getContext());
       PaginationResponse<Equipment> page5_name = remoteInterface.searchByMacAndName(customerId_1, "qr", sortBy, page4_name.getContext());
       PaginationResponse<Equipment> page6_name = remoteInterface.searchByMacAndName(customerId_1, "qr", sortBy, page5_name.getContext());
       PaginationResponse<Equipment> page7_name = remoteInterface.searchByMacAndName(customerId_1, "qr", sortBy, page6_name.getContext());
       ...
       //test first page of the results with empty sort order -> default sort order (by Id ascending)
       PaginationResponse<Equipment> page1EmptySort = remoteInterface.searchByMacAndName(customerId_1, "A1", Collections.emptyList(), context);
       assertEquals(10, page1EmptySort.getItems().size());
       ...
       //test first page of the results with null sort order -> default sort order (by Id ascending)
       PaginationResponse<Equipment> page1NullSort = remoteInterface.searchByMacAndName(customerId_1, "A1", null, context);
       assertEquals(10, page1NullSort.getItems().size());
       ...
       //test first page of the results with sort descending order by a name property 
       PaginationResponse<Equipment> page1SingleSortDesc = remoteInterface.searchByMacAndName(customerId_1, "A1", Collections.singletonList(new ColumnAndSort("name", SortOrder.desc)), context);
       assertEquals(10, page1SingleSortDesc.getItems().size());

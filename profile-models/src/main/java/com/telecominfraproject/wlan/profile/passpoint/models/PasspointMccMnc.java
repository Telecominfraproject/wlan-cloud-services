...
public class PasspointMccMnc extends BaseJsonModel {
    ...
    public PasspointMccMnc() {

    }

    public static PasspointMccMnc createWithDefaults() {
        return new PasspointMccMnc();
    }

    public PasspointMccMnc(int mcc, int mnc) {
        this();
        this.mcc = mcc;
        this.mnc = mnc;
    }
    ...
    @Override
    public PasspointMccMnc clone() {
        PasspointMccMnc ret = (PasspointMccMnc) super.clone();
        ret.country = country;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PasspointMccMnc)) {
            return false;
        }
        PasspointMccMnc other = (PasspointMccMnc) obj;

...
@Rollback(value = true)
@Transactional
@Import(value = { PortalUserDatastoreRdbms.class, PortalUserDataSourceConfig.class,
        PortalUserDAO.class, BaseJdbcTest.Config.class })
@TestWithEmbeddedDB
public class PortalUserDatastoreRdbmsTests extends BasePortalUserDatastoreTest {

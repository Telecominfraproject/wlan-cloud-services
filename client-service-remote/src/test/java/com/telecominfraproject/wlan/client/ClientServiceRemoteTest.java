...
//       System.out.println("================================");
    ...
    public void testClientSessionPagination()
    {
       ...
       PaginationResponse<ClientSession> page1 = remoteInterface.getSessionsForCustomer(customerId_1, null, sortBy, context);
       PaginationResponse<ClientSession> page2 = remoteInterface.getSessionsForCustomer(customerId_1, null, sortBy, page1.getContext());
       PaginationResponse<ClientSession> page3 = remoteInterface.getSessionsForCustomer(customerId_1, null, sortBy, page2.getContext());
       PaginationResponse<ClientSession> page4 = remoteInterface.getSessionsForCustomer(customerId_1, null, sortBy, page3.getContext());
       PaginationResponse<ClientSession> page5 = remoteInterface.getSessionsForCustomer(customerId_1, null, sortBy, page4.getContext());
       PaginationResponse<ClientSession> page6 = remoteInterface.getSessionsForCustomer(customerId_1, null, sortBy, page5.getContext());
       PaginationResponse<ClientSession> page7 = remoteInterface.getSessionsForCustomer(customerId_1, null, sortBy, page6.getContext());
...
//       System.out.println("================================");
       ...
       //test first page of the results with empty sort order -> default sort order (by Id ascending)
       PaginationResponse<ClientSession> page1EmptySort = remoteInterface.getSessionsForCustomer(customerId_1, null, Collections.emptyList(), context);
       assertEquals(10, page1EmptySort.getItems().size());
       ...
       //test first page of the results with null sort order -> default sort order (by Id ascending)
       PaginationResponse<ClientSession> page1NullSort = remoteInterface.getSessionsForCustomer(customerId_1, null, null, context);
       assertEquals(10, page1NullSort.getItems().size());
       ...
       //test first page of the results with sort descending order by a macAddress property 
       PaginationResponse<ClientSession> page1SingleSortDesc = remoteInterface.getSessionsForCustomer(customerId_1, null, Collections.singletonList(new ColumnAndSort("macAddress", SortOrder.desc)), context);
       assertEquals(10, page1SingleSortDesc.getItems().size());
       ...
       PaginationResponse<ClientSession> page1Eq_1 = remoteInterface.getSessionsForCustomer(customerId_1, new HashSet<Long>(Arrays.asList(equipmentId_1)), Collections.emptyList(), context);
       PaginationResponse<ClientSession> page2Eq_1 = remoteInterface.getSessionsForCustomer(customerId_1, new HashSet<Long>(Arrays.asList(equipmentId_1)), Collections.emptyList(), page1Eq_1.getContext());
       ...
       PaginationResponse<ClientSession> page1Eq_2 = remoteInterface.getSessionsForCustomer(customerId_1, new HashSet<Long>(Arrays.asList(equipmentId_2)), Collections.emptyList(), context);
       PaginationResponse<ClientSession> page2Eq_2 = remoteInterface.getSessionsForCustomer(customerId_1, new HashSet<Long>(Arrays.asList(equipmentId_2)), Collections.emptyList(), page1Eq_2.getContext());
       ...
       PaginationResponse<ClientSession> page1Eq_1or2 = remoteInterface.getSessionsForCustomer(customerId_1, new HashSet<Long>(Arrays.asList(equipmentId_1, equipmentId_2)), Collections.emptyList(), context);
       PaginationResponse<ClientSession> page2Eq_1or2 = remoteInterface.getSessionsForCustomer(customerId_1, new HashSet<Long>(Arrays.asList(equipmentId_1, equipmentId_2)), Collections.emptyList(), page1Eq_1or2.getContext());
       PaginationResponse<ClientSession> page3Eq_1or2 = remoteInterface.getSessionsForCustomer(customerId_1, new HashSet<Long>(Arrays.asList(equipmentId_1, equipmentId_2)), Collections.emptyList(), page2Eq_1or2.getContext());

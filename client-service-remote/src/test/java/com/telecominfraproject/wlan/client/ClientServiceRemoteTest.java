...
public class ClientServiceRemoteTest extends BaseRemoteTest {
    ...
    public void testClientCRUD() throws Exception {
        ...
        //TODO: add more Client fields to modify here
        
        Client updatedClient = remoteInterface.update(ret);
        assertEqualClients(ret, updatedClient);
        ...
        try{
            ...
            remoteInterface.update(updatedClient);
            fail("updated non-existent Client");
        }catch(RuntimeException e){
            //expected it
        }
        ...
        try{
            ...
            fail("deleted non-existent Client");
        }catch(RuntimeException e){
            //expected it
        }
    ...
    public void testGetAllInSet() {
        ...
        List<Client> clientsRetrievedByIdSet = remoteInterface.get(testSetIds);
...
//       System.out.println("================================");
       ...
       PaginationResponse<Client> page1SingleSortDesc = remoteInterface.getForCustomer(customerId_1, Collections.singletonList(new ColumnAndSort("sampleStr", SortOrder.desc)), context);

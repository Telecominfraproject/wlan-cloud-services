 ...
 *
 */
public class Routing extends BaseJsonModel implements HasCustomerId {
    ...
    private RoutingDetails details;
	...
	public RoutingDetails getDetails() {
		return details;
	}

	public void setDetails(RoutingDetails details) {
    ...
    public Routing clone() {
    	Routing ret = (Routing) super.clone();
    	if(details!=null) {

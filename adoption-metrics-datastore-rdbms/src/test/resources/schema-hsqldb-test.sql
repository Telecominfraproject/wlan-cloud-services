drop table adoption_metrics_counters if exists;
drop table adoption_metrics_uniq_macs if exists;
...
create table if not exists adoption_metrics_uniq_macs (
    ...
    -- allow duplicates in this table in hsqldb - for testing
    -- in postgresql we're using INSERT ...  ON CONFLICT DO NOTHING feature

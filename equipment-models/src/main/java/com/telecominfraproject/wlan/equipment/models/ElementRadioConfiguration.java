...
public class ElementRadioConfiguration extends BaseJsonModel {
    ...
    public static ElementRadioConfiguration createWithDefaults(RadioType radioType)
    {
       ...
       {
          returnValue.setChannelBandwidth(ChannelBandwidth.is40MHz);
...
//
    ...
    public void setClientDisconnectThresholdDb(
          AutoOrManualValue clientDisconnectThresholdDb) {
    ...
    public void setProbeResponseThresholdDb(
          AutoOrManualValue probeResponseThresholdDb) {

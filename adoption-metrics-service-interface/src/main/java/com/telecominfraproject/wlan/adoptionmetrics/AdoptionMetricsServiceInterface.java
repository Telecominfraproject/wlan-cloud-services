 ...
 *
 */
public interface AdoptionMetricsServiceInterface {
     ...
     */
    GenericResponse update(List<ServiceAdoptionMetrics> serviceAdoptionMetricsList);
    ...
    GenericResponse updateUniqueMacs(long timestampMs, int customerId, long locationId, long equipmentId, Set<Long> clientMacSet);

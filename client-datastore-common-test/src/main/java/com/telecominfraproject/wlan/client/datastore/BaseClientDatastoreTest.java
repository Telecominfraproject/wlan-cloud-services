...
public abstract class BaseClientDatastoreTest {
    ...
    public void testCRUD() {
        ...
        assertEquals(client.getSampleStr(), created.getSampleStr());
        ...
        //retrieve
        Client retrieved = testInterface.get(created.getId());
    ...
    public void testGetAllInSet() {
        ...
        List<Client> clientsRetrievedByIdSet = testInterface.get(testSetIds);
...
//       System.out.println("================================");
       ...
       PaginationResponse<Client> page1SingleSortDesc = testInterface.getForCustomer(customerId_1, Collections.singletonList(new ColumnAndSort("sampleStr", SortOrder.desc)), context);

...
public class RoutingDAO extends BaseJdbcDao {
    ...
    private static final String[] ALL_COLUMNS_LIST = {        
        ...
        //TODO: add colums from properties Routing in here
        "customerId",
        "sampleStr",
        "details",
    ...
    private static final String TABLE_NAME = "routing";
    ...
    private static final RowMapper<Routing> routingRowMapper = new RoutingRowMapper();
    ...
    public Routing create(final Routing routing) {
            ...
            jdbcTemplate.update(
                new PreparedStatementCreator() {
                    public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
                        ...
                        //TODO: add remaining properties from Routing here 
                        ps.setInt(colIdx++, routing.getCustomerId());
                        ps.setString(colIdx++, routing.getSampleStr());
                      	ps.setBytes(colIdx++, (routing.getDetails()!=null)?routing.getDetails().toZippedBytes():null);
        ...
        LOG.debug("Stored Routing {}", routing);
    ...
    public Routing get(long routingId) {
        ...
        try{
            Routing routing = this.jdbcTemplate.queryForObject(
                    SQL_GET_BY_ID,
    ...
    public Routing getOrNull(long routingId) {
        ...
        try{
            ...
            LOG.debug("Could not find Routing for id {}", routingId);
            return null;
        }
    }
    ...
    public Routing update(Routing routing) {
        ...
        int updateCount = this.jdbcTemplate.update(SQL_UPDATE, new Object[]{ 
                ...
                routing.getSampleStr(),
                (routing.getDetails()!=null)?routing.getDetails().toZippedBytes():null ,
        ...
        if(updateCount==0){
            ...
            try{
                ...
                LOG.debug("Cannot find Routing for {}", routing.getId());
                throw new DsEntityNotFoundException("Routing not found " + routing.getId());
            }
        }
    ...
    public List<Routing> getAllForCustomer(int customerId) {
        LOG.debug("Looking up Routings for customer {}", customerId);

        List<Routing> ret = this.jdbcTemplate.query(SQL_GET_BY_CUSTOMER_ID,
    ...
    public List<Routing> get(Set<Long> routingIdSet) {
        ...
        List<Routing> results = this.jdbcTemplate.query(query, routingIdSet.toArray(), routingRowMapper);
	...
	public PaginationResponse<Routing> getForCustomer(int customerId, List<ColumnAndSort> sortBy,
         ...
         */
        List<Routing> pageItems = this.jdbcTemplate.query(query, queryArgs.toArray(),
                routingRowMapper);

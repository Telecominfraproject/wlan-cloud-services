...
@Rollback(value = true)
@Transactional
@Import(value = { ServiceMetricDatastoreRdbms.class, ServiceMetricDataSourceConfig.class,
        ServiceMetricDAO.class, BaseJdbcTest.Config.class })
@TestWithEmbeddedDB
public class ServiceMetricDatastoreRdbmsTests extends BaseServiceMetricDatastoreTest {

...
@Rollback(value = true)
@Transactional
@Import(value = { SystemEventDatastoreRdbms.class, SystemEventDataSourceConfig.class,
        SystemEventDAO.class, BaseJdbcTest.Config.class })
@TestWithEmbeddedDB
public class SystemEventDatastoreRdbmsTests extends BaseSystemEventDatastoreTest {

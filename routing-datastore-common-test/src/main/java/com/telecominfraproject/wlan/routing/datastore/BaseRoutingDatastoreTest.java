...
public abstract class BaseRoutingDatastoreTest {
    ...
    public void testCRUD() {
    	Routing routing = createRoutingObject();

        //create
    	Routing created = testInterface.create(routing);
        assertNotNull(created);
        assertTrue(created.getId() > 0);
        assertEquals(routing.getSampleStr(), created.getSampleStr());
        assertEquals(routing.getCustomerId(), created.getCustomerId());
        assertNotNull(created.getDetails());
        assertEquals(routing.getDetails(), created.getDetails());
                
        // update
        created.setSampleStr(created.getSampleStr()+"_updated");
        Routing updated = testInterface.update(created);
        assertNotNull(updated);
        assertEquals(created.getSampleStr(), updated.getSampleStr());
        
        //UPDATE test - fail because of concurrent modification exception
        try{
        	Routing modelConcurrentUpdate = created.clone();
        ...
        //retrieve
        Routing retrieved = testInterface.get(created.getId());
    ...
    public void testGetAllInSet() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Routing ret = testInterface.create(routing);
        ...
        List<Routing> routingsRetrievedByIdSet = testInterface.get(testSetIds);
    ...
    public void testRoutingPagination()
    {
       ...
       PaginationResponse<Routing> page1 = testInterface.getForCustomer(customerId_1, sortBy, context);
       PaginationResponse<Routing> page2 = testInterface.getForCustomer(customerId_1, sortBy, page1.getContext());
       PaginationResponse<Routing> page3 = testInterface.getForCustomer(customerId_1, sortBy, page2.getContext());
       PaginationResponse<Routing> page4 = testInterface.getForCustomer(customerId_1, sortBy, page3.getContext());
       PaginationResponse<Routing> page5 = testInterface.getForCustomer(customerId_1, sortBy, page4.getContext());
       PaginationResponse<Routing> page6 = testInterface.getForCustomer(customerId_1, sortBy, page5.getContext());
       PaginationResponse<Routing> page7 = testInterface.getForCustomer(customerId_1, sortBy, page6.getContext());
...
//       System.out.println("================================");
       ...
       PaginationResponse<Routing> page1EmptySort = testInterface.getForCustomer(customerId_1, Collections.emptyList(), context);
       ...
       PaginationResponse<Routing> page1NullSort = testInterface.getForCustomer(customerId_1, null, context);
       ...
       PaginationResponse<Routing> page1SingleSortDesc = testInterface.getForCustomer(customerId_1, Collections.singletonList(new ColumnAndSort("sampleStr", SortOrder.desc)), context);
    ...
    private Routing createRoutingObject() {

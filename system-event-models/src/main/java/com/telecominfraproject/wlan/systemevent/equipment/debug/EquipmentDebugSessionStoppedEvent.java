 ...
 *
 */
public class EquipmentDebugSessionStoppedEvent extends SystemEvent {
    ...
    public EquipmentDebugSessionStoppedEvent() {
        // for serialization
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EquipmentDebugSessionStoppedEvent)) {
            return false;
        }
        EquipmentDebugSessionStoppedEvent other = (EquipmentDebugSessionStoppedEvent) obj;
    ...
    @Override
    public EquipmentDebugSessionStoppedEvent clone() {
        return (EquipmentDebugSessionStoppedEvent) super.clone();
    }    
}
